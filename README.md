...
[![Tests](https://github.com/elkins-lab/synth-cryo-em/actions/workflows/test.yml/badge.svg)](https://github.com/elkins-lab/synth-cryo-em/actions/workflows/test.yml)
...
[![codecov](https://codecov.io/gh/elkins-lab/synth-cryo-em/branch/main/graph/badge.svg)](https://codecov.io/gh/elkins-lab/synth-cryo-em)
...
- **Interactive Physics & Visualization**: Explore how resolution, noise (SNR), and CTF effects change the visual features of a map in 3D.
  [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/elkins-lab/synth-cryo-em/blob/main/notebooks/visual_tutorial.ipynb)
- **Core API Walkthrough**: A step-by-step guide to using the Python API for custom workflows.
  [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/elkins-lab/synth-cryo-em/blob/main/notebooks/interactive_tutorial.ipynb)
...
- [synth-dynamics](https://github.com/elkins-lab/synth-dynamics) — ANM/Langevin dynamics engine
- [diff-biophys](https://github.com/elkins-lab/diff-biophys) — Differentiable JAX biophysics kernels

## Contributing

Contributions are welcome! Please open an issue or pull request on [GitHub](https://github.com/elkins-lab/synth-cryo-em). Run `pre-commit run --all-files` before submitting.
